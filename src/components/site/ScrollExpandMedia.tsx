        ...
        <div className="relative w-full flex flex-col items-center min-h-[100dvh]">
          ...
          <div className="container mx-auto flex flex-col items-center justify-start relative z-10">
            <div className="flex flex-col items-center justify-center w-full h-[100dvh] relative">
                ...
                {mediaType === "video" ? (
                  mediaSrc.includes("youtube.com") ? (
                    <div className="relative w-full h-full pointer-events-none">
                      ...
                      />
                      <motion.div
                        className="absolute inset-0 bg-foreground/30 rounded-xl"
                        initial={{ opacity: 0.7 }}
                  ...
                  <div className="relative w-full h-full">
                    ...
                    />
                    <motion.div
                      className="absolute inset-0 bg-foreground/40 rounded-xl"
                      initial={{ opacity: 0.7 }}
              ...
              >
                <motion.h2
                  className="text-4xl md:text-5xl lg:text-6xl font-display text-background"
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {firstWord}
                </motion.h2>
                <motion.h2
                  className="text-4xl md:text-5xl lg:text-6xl font-display text-center text-background"
                  style={{ transform: `translateX(${textTranslateX}vw)` }}
                >
                  {restOfTitle}
                </motion.h2>
